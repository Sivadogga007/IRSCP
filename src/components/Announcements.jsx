...
import { Link } from 'react-router-dom'; // For routing (make sure you are using react-router-dom)
...
export default function Announcements() {
  ...
  return (
    <div className="bg-gray-100 px-3 py-10 md:px-7 relative  border-t border-gray-200">
      ...
      >
        {announcementData.slice(0, 6).map((announcement, index) => {
      ...
      <div className="text-center mt-6">
        <Link
          to="/Announcements"  // Link to the 'All Announcements' page
