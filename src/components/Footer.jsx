                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        ...
                        <p className="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left">
                            The Institute Research Scholar Companion Programme (IRSCP), IIT Bombay 
                        </p>
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:grid-cols-2 md:grid-cols-4 m-10 lg:col-span-2">
                        <div >
                        ...
                        <div >
                            <p className="text-lg font-medium text-gray-900">IIT Bombay Links</p>
                        ...
                        <div >
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                ...
                                <li>
                                    <a className="text-gray-700 transition hover:text-gray-700/75" href="">Credit Requirement</a>
                                </li>
                                <li>
                                    <a className="text-gray-700 transition hover:text-gray-700/75" href="">Campus Life</a>
                                </li>

                                <li>
                                    <a className="text-gray-700 transition hover:text-gray-700/75" href="#">Insti App</a>
                                </li>
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                ...
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="flex-1 text-gray-700">iitbirscp@gmail.com</span>
                                    </a>
                                </li>
                                <li>
                                    <a
                                    ...
                                    >
                                        ...
                                        <span className="flex-1 text-gray-700">rscp@iitb.ac.in</span>
                                    </a>
                                </li>
